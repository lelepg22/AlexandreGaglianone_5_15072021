...
function commanderInput() { if(document.querySelector('#gridCheck:checked') != null ) {
    ...
    //  alert("Numero Commande : " + contact.commandeId)
     objectEnvoye = { products , contact: { firstName: "sqsqs" , lastName: "dqsdqs" , adress: "21 sss"  ,city: "tol" ,email: "lel@lel.kle"} }
     baby = JSON.stringify(objectEnvoye)
     xhr.send(baby);
